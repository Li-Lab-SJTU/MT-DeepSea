...
if (params.stdin1 == null && params.stdin2 == null && params.trim == null && params.adapter == null && params.rrna_db == null && params.ref == null && params.gtf == null && params.kraken2_db == null) {
    HelpMessage()
    exit 0
}
...
def Warnings() {
    ...
    if (params.trim == null) {
        println "\nError:\n     The trimmomatic.jar is not found, please specify it by adding the --trimmomatic parameter in the command-line!\n"
        exit 0
    }
...
process qualityControl {
    ...
    java -jar $params.trim PE -phred33 $r1 $r2 \${c1} \${t1} \${c2} \${t2} ILLUMINACLIP:${params.adapter}:2:30:10:1:true LEADING:3 TRAILING:3 SLIDINGWINDOW:4:20 MINLEN:50 HEADCROP:10
    """
}
...
process featureCounts {
    ...
    python $project_dir/06_tpm.py ${sample}_bp_trim.txt ${sample}_bp_trim_tpm.txt
    """
}
